      ...
      <section className="AboutUs">
        ...
        <div className="AboutUs-content">
          <div className="AboutUs-p">
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora totam eligendi sequi quia, ipsam excepturi laudantium nesciunt vero id eaque nemo impedit commodi amet cupiditate voluptatum, fuga perspiciatis fugiat error?
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus iure velit sed quas ipsum sit soluta laudantium fugiat accusantium repellendus, minima nulla ab ad eaque voluptates sint magni impedit vel molestias similique placeat adipisci pariatur asperiores! At perferendis tenetur in sapiente optio quaerat debitis neque deleniti cupiditate saepe numquam totam quae ullam fugiat, quia quod odio, quo provident, dignissimos facere et possimus! Nulla, quas. Reiciendis deserunt omnis quibusdam animi ratione iste laborum sed adipisci nam voluptas fuga maiores illo aut, odit ullam temporibus, ipsum ad quasi? Error ex, enim vel commodi incidunt quas, beatae adipisci dignissimos tempore eaque ab voluptas!
            </p>
          </div>
          <div>
